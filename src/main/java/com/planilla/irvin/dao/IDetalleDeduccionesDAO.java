 ...
 * @author irvin
 */
public interface IDetalleDeduccionesDAO extends JpaRepository<TBL_Detalle_Deducciones, Long> {

    public Iterable<TBL_Detalle_Deducciones> findByHistorial(TBL_Detalle_Historial_Planillas detalle);
